...
export default function MantraSadhna({ heading = true }: MantraSadhnaProps) {
            ...
            <div className="flex ">
              ...
              <div>
                <h5 className="text-right text-black content-area-heading">
                  {t("Subtitle_Mantra_Sadhna")}
                </h5>
                <p className="mt-5  content-area-para line-clamp-3">
                  {t("Body_Mantra_Sadhna")}
                </p>
