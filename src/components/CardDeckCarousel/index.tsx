...
const CardDeckCarousel: React.FC<CardDeckCarouselProps> = ({
  ...
  return (
    ...
    <div className="relative w-full max-w-[70vw] mx-auto min-h-[620px] overflow-visible mt-40">
        ...
        <img  src="kundli/mandla.svg" className="top-image bg-mandla responsive-img" alt=""/>
      <div className="relative h-full w-full  overflow-visible ">
        ...
        {children.map((child, index) => {
          ...
          const baseOffset =
            window.innerWidth < 640 ? 15 : window.innerWidth < 1024 ? 25 : 20;
         ...
         <img  src="kundli/mandla.svg" className="bottom-image bg-mandla responsive-img" alt=""/>
